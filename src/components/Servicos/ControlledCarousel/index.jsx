        ...
        >
          { array[index - 1] && 
            <Card><Figure.Image
              ...
              height={200}
              alt="171x180"
              src={array[index - 1] ? array[index - 1].image : array[index].image}
            />
            <Card.Text>{array[index - 1] ? array[index - 1].text : array[index].text}</Card.Text>
            </Card>}
            <Card>
              <Figure.Image
              className="d-block"
            ...
            <Figure.Image
              ...
              height={200}
              alt="171x180"
              src={array[index + 1] ? array[index + 1].image : array[0].image}
              />
              <Card.Text>{array[index + 1] ? array[index + 1].text : array[0].text}</Card.Text>
            </Card>
          </Stack>
        </Carousel.Item>))}
